...
define('libertyjs-dev/app', ['exports', 'ember', 'ember/resolver', 'ember/load-initializers', 'libertyjs-dev/config/environment'], function (exports, Ember, Resolver, loadInitializers, config) {
...
define('libertyjs-dev/callforproposals/route', ['exports', 'ember'], function (exports, Ember) {
...
define('libertyjs-dev/callforproposals/template', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      ...
      return {
        ...
        build: function build(dom) {
          ...
          var el3 = dom.createTextNode("Call For Proposals");
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h2");
            var el2 = dom.createTextNode("Call For Proposals");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      You should speak at LibertyJS! Yes you! We are looking for Speakers and\n      Workshop Facilitators.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("The Process");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n    ");
            dom.appendChild(el0, el1);
            ...
            var el3 = dom.createTextNode("\n        We anonymize submissions, to avoid bias.\n      ");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("A panel of four will score each proposal on 0 to 10 scale");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Scores are tallied");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("\n        A second round of votes will be tallied based on de-anonymized\n        proposals.  This round will account for ability to cover travel, under\n        represented individuals and new speakers.\n      ");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("Panelists will be chosen from varied level of experience and gender");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("What we are looking for");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      We are looking for several Workshop leaders for the morning sessions.\n      Topics should appeal to wide audience of JavaScript developers.  Last year\n      our workshops included: AngularJS, Node, and an Intro to JS.\n      Proposed workshops include: AngularJS, EmberJS, React, Polymer, JavaScript\n      design patterns, functional JavaScript, etc. This list is not exhaustive\n      and all proposals are welcome.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            ...
            dom.setAttribute(el1,"height","1150");
...
define('libertyjs-dev/codeofconduct/route', ['exports', 'ember'], function (exports, Ember) {
...
define('libertyjs-dev/codeofconduct/template', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      ...
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("span");
          var el3 = dom.createTextNode("Code of Conduct");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n  ");
          dom.appendChild(el1, el2);
    ...
    var child1 = (function() {
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h2");
            var el2 = dom.createTextNode("Code of Conduct");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      We value the participation of each member of the community and want\n      everyone to have an enjoyable and fulfilling experience. Accordingly, all\n      members are expected to show respect and courtesy to other members.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      To make clear what is expected, all members, organizers and volunteers\n      associated with the LibertyJS community are required to conform to the\n      following Code of Conduct.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      Be kind to others. Do not insult or put down other members. Behave\n      professionally. Remember that harassment and sexist, racist, or\n      exclusionary jokes are not appropriate for the LibertyJS community.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      Members violating these rules may be asked to leave the group at the sole\n      discretion of the organizers.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            ...
            dom.setAttribute(el3,"href","https://twitter.com/pamasaur");
            ...
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("a");
            dom.setAttribute(el3,"href","https://phillydev.slack.com/messages/@pam/");
            var el4 = dom.createTextNode("Slack");
            dom.appendChild(el3, el4);
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode("\n      ");
            dom.appendChild(el2, el3);
            ...
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("a");
            dom.setAttribute(el3,"href","https://twitter.com/jsacra");
            var el4 = dom.createTextNode("Twitter");
            dom.appendChild(el3, el4);
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode("\n      ");
            ...
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("a");
            dom.setAttribute(el3,"href","https://twitter.com/belcherj");
            var el4 = dom.createTextNode("Twitter");
            dom.appendChild(el3, el4);
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode(" -\n        ");
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("a");
            dom.setAttribute(el3,"href","https://phillydev.slack.com/messages/@belcherj/");
            var el4 = dom.createTextNode("Slack");
            dom.appendChild(el3, el4);
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode("\n      ");
            ...
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("a");
            dom.setAttribute(el3,"href","https://twitter.com/VossJenn");
            var el4 = dom.createTextNode("Twitter");
            dom.appendChild(el3, el4);
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode(" -\n        ");
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("a");
            dom.setAttribute(el3,"href","https://phillydev.slack.com/messages/@jvoss/");
            var el4 = dom.createTextNode("Slack");
            dom.appendChild(el3, el4);
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode("\n      ");
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("License");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            ...
            dom.setAttribute(el2,"href","https://us.pycon.org/2013/about/code-of-conduct/");
            var el3 = dom.createTextNode("\n        PyCon Code of Conduct\n      ");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode(" which was forked from the example policy from the\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("a");
            dom.setAttribute(el2,"href","http://geekfeminism.wikia.com/wiki/Conference_anti-harassment/Policy");
            var el3 = dom.createTextNode("\n        Geek Feminism wiki, created by the Ada Initiative\n      ");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      and other volunteers under a Creative Commons Zero license.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            ...
            dom.setAttribute(el1,"src","http://i.creativecommons.org/l/by/3.0/88x31.png");
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      Code of Conduct for the PhillyDev group is licensed under a\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("a");
            dom.setAttribute(el2,"href","http://creativecommons.org/licenses/by/3.0/");
      ...
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("img");
          dom.setAttribute(el1,"class","title-image");
          dom.setAttribute(el1,"src","/assets/images/logo-full.png");
          dom.setAttribute(el1,"alt","LibertyJS Logo");
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
          dom.appendChild(el0, el1);
          var el1 = dom.createComment("");
...
define('libertyjs-dev/components/base-focusable', ['exports', 'ember-paper/components/base-focusable'], function (exports, BaseFocusable) {
...
define('libertyjs-dev/components/paper-backdrop', ['exports', 'ember-paper/components/paper-backdrop'], function (exports, PaperBackdrop) {
...
define('libertyjs-dev/components/paper-button', ['exports', 'ember-paper/components/paper-button'], function (exports, PaperButton) {
...
define('libertyjs-dev/components/paper-card-content', ['exports', 'ember-paper/components/paper-card-content'], function (exports, PaperCardContent) {
...
define('libertyjs-dev/components/paper-card', ['exports', 'ember-paper/components/paper-card'], function (exports, PaperCard) {
...
define('libertyjs-dev/components/paper-checkbox', ['exports', 'ember-paper/components/paper-checkbox'], function (exports, PaperCheckbox) {
...
define('libertyjs-dev/components/paper-content', ['exports', 'ember-paper/components/paper-content'], function (exports, PaperContent) {
...
define('libertyjs-dev/components/paper-divider', ['exports', 'ember-paper/components/paper-divider'], function (exports, PaperDivider) {
...
define('libertyjs-dev/components/paper-icon', ['exports', 'ember-paper/components/paper-icon'], function (exports, PaperIcon) {
...
define('libertyjs-dev/components/paper-item', ['exports', 'ember-paper/components/paper-item'], function (exports, PaperItem) {
...
define('libertyjs-dev/components/paper-list', ['exports', 'ember-paper/components/paper-list'], function (exports, PaperList) {
...
define('libertyjs-dev/components/paper-nav-container', ['exports', 'ember-paper/components/paper-nav-container'], function (exports, PaperNavContainer) {
...
define('libertyjs-dev/components/paper-radio', ['exports', 'ember-paper/components/paper-radio'], function (exports, PaperRadio) {
...
define('libertyjs-dev/components/paper-sidenav-toggle', ['exports', 'ember-paper/components/paper-sidenav-toggle'], function (exports, PaperSidenavToggle) {
...
define('libertyjs-dev/components/paper-sidenav', ['exports', 'ember-paper/components/paper-sidenav'], function (exports, PaperSidenav) {
...
define('libertyjs-dev/components/paper-switch', ['exports', 'ember-paper/components/paper-switch'], function (exports, PaperSwitch) {
...
define('libertyjs-dev/components/paper-text', ['exports', 'ember-paper/components/paper-text'], function (exports, PaperText) {
...
define('libertyjs-dev/components/paper-tile-content', ['exports', 'ember-paper/components/paper-tile-content'], function (exports, PaperTileContent) {
...
define('libertyjs-dev/components/paper-tile-left', ['exports', 'ember-paper/components/paper-tile-left'], function (exports, PaperTileLeft) {
...
define('libertyjs-dev/components/paper-toolbar', ['exports', 'ember-paper/components/paper-toolbar'], function (exports, PaperToolbar) {
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h2");
            var el2 = dom.createTextNode("LibertyJS");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      Your friendly Philly JavaScript conference.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h2");
            var el2 = dom.createTextNode("Sponsors");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n    ");
            dom.appendChild(el0, el1);
...
define('libertyjs-dev/initializers/app-version', ['exports', 'libertyjs-dev/config/environment', 'ember'], function (exports, config, Ember) {
...
define('libertyjs-dev/initializers/export-application-global', ['exports', 'ember', 'libertyjs-dev/config/environment'], function (exports, Ember, config) {
...
define('libertyjs-dev/router', ['exports', 'ember', 'libertyjs-dev/config/environment'], function (exports, Ember, config) {
...
define('libertyjs-dev/schedule/template', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      ...
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("span");
          var el3 = dom.createTextNode("Schedule");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n  ");
          dom.appendChild(el1, el2);
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h2");
            var el2 = dom.createTextNode("Schedule - Saturday, June 20th, 2015");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n  ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("9:00 am Registration & Welcome");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n  ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Register between 9-9:40 and grab some bagels & coffee!");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Welcome/Opening Remarks at 9:45");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n  ");
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("10:00 am Workshops");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n  ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("12:30 pm Lunch");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n  ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("1:00 pm Talk 1");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n  ");
            dom.appendChild(el0, el1);
            ...
            var el3 = dom.createTextNode("Ken Dale");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode(" - Bring the Rain: Cloud Powered Continuous Delivery");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n  ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("strong");
            var el3 = dom.createTextNode("Kevin Clough and Lauren Ancona");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode(" - Who Won Philly");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n  ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("2:00 pm Talk 2");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n  ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("strong");
            var el3 = dom.createTextNode("Tommy Everett");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode(" - JS Code Evaluation: Soup to Nuts");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n  ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("strong");
            var el3 = dom.createTextNode("Warren Longmire");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode(" - Intro to HTML5 Game Development");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n  ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("3:00 pm Talk 3");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n  ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("strong");
            var el3 = dom.createTextNode("Ben Spoon");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode(" - Protect yourself from Zombies with Javascript");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n  ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("4:00 pm Talk 4");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n  ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("strong");
            var el3 = dom.createTextNode("William Jeffries");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode(" - Cognitive Bias and Code");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n  ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("strong");
            var el3 = dom.createTextNode("Kelly Campbell");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode(" - Digging into Cordova Plugins");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n  ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("4:45 pm After Conference Social!");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n  ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n    In the evening, we'll round it off with a good old fashioned social,\n    thoroughly enjoying ImpactHub's deck. Open to the public (friends welcome!).\n  ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n  ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Food!");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Open bar (WHAT)");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Did we mention the deck?? A beautiful space in summer!");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n  ");
            dom.appendChild(el1, el2);
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            dom.setAttribute(el1,"id","denineguy");
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            dom.setAttribute(el1,"id","kenrimple");
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            dom.setAttribute(el1,"id","chadostrowski");
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            dom.setAttribute(el1,"id","maxminkoff");
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            dom.setAttribute(el1,"id","kendale");
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            dom.setAttribute(el1,"id","tommyeverett");
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            dom.setAttribute(el1,"id","williamjeffries");
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            dom.setAttribute(el1,"id","kevinclough");
            var el2 = dom.createTextNode("Kevin Clough and Lauren Ancona - Who Won Philly");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n    ");
            dom.appendChild(el0, el1);
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            dom.setAttribute(el1,"id","warrenlongmire");
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            dom.setAttribute(el1,"id","benspoon");
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      Imagine a world where you were being attacked by zombies every day. You are constantly looking out the window waiting for the next zombie to walk by. Your sleep, and your sanity are taking hits because of it. Why not automate some things to make your life easier?\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      Did you know that you can build a complete alarm system using JavaScript? Did you know that you can build Drones? What about Robots? Web Servers? Databases? In this talk we will talk about how you can gain some of your sanity back  from the zombies, all with JavaScript.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n");
            dom.appendChild(el0, el1);
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            dom.setAttribute(el1,"id","kellycampbell");
    ...
    var child0 = (function() {
      ...
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("span");
          var el3 = dom.createTextNode("Sponsors");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n  ");
          dom.appendChild(el1, el2);
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("div");
            dom.setAttribute(el1,"class","sponsor");
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("a");
            dom.setAttribute(el2,"href","http://www.elsevier.com/");
            dom.setAttribute(el2,"title","Elsevier");
            var el3 = dom.createTextNode("\n      ");
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("img");
            dom.setAttribute(el3,"src","/assets/images/elsevier-logo.jpg");
            dom.setAttribute(el3,"alt","Elsevier logo");
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode("\n    ");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("a");
            dom.setAttribute(el2,"href","http://www.teksystems.com/");
            dom.setAttribute(el2,"title","TEKsystems");
            var el3 = dom.createTextNode("\n      ");
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("img");
            dom.setAttribute(el3,"src","/assets/images/teksystems-logo.jpg");
            dom.setAttribute(el3,"alt","TEKsystems logo");
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode("\n    ");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("a");
            dom.setAttribute(el2,"href","http://chariotsolutions.com/");
            dom.setAttribute(el2,"title","Chariot Solutions");
            var el3 = dom.createTextNode("\n      ");
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("img");
            dom.setAttribute(el3,"src","/assets/images/ChariotLogo.jpg");
            dom.setAttribute(el3,"alt","Chariot logo");
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode("\n    ");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("p");
            var el3 = dom.createTextNode("Passionate About Technology: If those three words describe you, you'll feel right at home at Chariot. We are a tight knit group of software professionals, putting our expertise to work for Philadelphia area companies every day.");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("a");
            dom.setAttribute(el2,"href","http://financialsystems.sungard.com/services/consulting-services");
            dom.setAttribute(el2,"title","SunGard Consulting Services Website");
            var el3 = dom.createTextNode("\n        ");
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("img");
            dom.setAttribute(el3,"src","/assets/images/sungard-logo.jpg");
            dom.setAttribute(el3,"alt","SunGard Logo");
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode("\n      ");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("a");
            dom.setAttribute(el2,"href","https://www.promptworks.com/");
            dom.setAttribute(el2,"title","Promptworks");
            var el3 = dom.createTextNode("\n      ");
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("img");
            dom.setAttribute(el3,"src","/assets/images/promptworks-logo.png");
            dom.setAttribute(el3,"alt","Promptworks Logo");
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode("\n    ");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("p");
            var el3 = dom.createTextNode("The premier Philadelphia software consulting shop. We help businesses build web apps & APIs, automate processes, and scale existing products.");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("a");
            dom.setAttribute(el2,"href","https://www.monetate.com/");
            dom.setAttribute(el2,"title","Monetate");
            var el3 = dom.createTextNode("\n      ");
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("img");
            dom.setAttribute(el3,"src","/assets/images/monetate-logo.png");
            dom.setAttribute(el3,"alt","Monetate Logo");
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("a");
            dom.setAttribute(el2,"href","http://www.aweber.com/home.htm");
            dom.setAttribute(el2,"title","AWeber");
            var el3 = dom.createTextNode("\n      ");
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("img");
            dom.setAttribute(el3,"src","/assets/images/aweber-logo.png");
            dom.setAttribute(el3,"alt","AWeber Logo");
            dom.setAttribute(el3,"style","padding-top:10px;");
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode("\n    ");
            dom.appendChild(el2, el3);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("p");
            var el3 = dom.createTextNode("AWeber develops and runs an opt-in email marketing service used by over 120,000+ small businesses, bloggers and entrepreneurs around the globe. Our web-based tools help businesses grow by staying in touch with customers and prospects through email.");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("a");
            dom.setAttribute(el2,"href","http://www.impacthub.net/");
            dom.setAttribute(el2,"title","Impact Hub Website");
            var el3 = dom.createTextNode("\n        ");
            dom.appendChild(el2, el3);
            var el3 = dom.createElement("img");
            dom.setAttribute(el3,"src","/assets/images/impact-hub-logo.png");
            dom.setAttribute(el3,"alt","Impact Hub Logo");
            dom.setAttribute(el3,"style","padding-top: 10px;");
            dom.appendChild(el2, el3);
            var el3 = dom.createTextNode("\n      ");
            dom.appendChild(el2, el3);
          ...
          render: function render(context, env, contextualElement) {
            ...
            var morph2 = dom.createMorphAt(fragment,13,13,contextualElement);
            content(env, morph0, context, "paper-divider");
...
define('libertyjs-dev/sponsorship/route', ['exports', 'ember'], function (exports, Ember) {
...
define('libertyjs-dev/sponsorship/template', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      ...
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("span");
          var el3 = dom.createTextNode("Sponsoship");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n  ");
          dom.appendChild(el1, el2);
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h2");
            var el2 = dom.createTextNode("Sponsorship Prospectus");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("What’s LibertyJS?");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      LibertyJS is the community-super-powered JavaScript conference in\n      Philadelphia, organized by the same team of Philadelphia JavaScript\n      Developers, the premier JavaScript user group with over 1000 members\n      enthusiastic about JavaScript development.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      Founded in 2014, LibertyJS is the first JavaScript conference to be held\n      in Philadelphia, and had over 100 attendees in its first year. We have\n      exciting plans for 2015, and we’d love you to be a part of the event.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      LibertyJS 2015 is Saturday, June 20, 2015 at ImpactHub in Philadelphia.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      LibertyJS provides unprecedented access to overwhelmingly local JavaScript\n      talent (although we confess to attracting some out-of-town attendees).\n      We’re gathering smart, motivated, technical individuals for one great\n      summer learning event, and by participating you’ll have the opportunity\n      to:\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Recruit for JavaScript roles at your organization");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Raise your profile among this specialized set of developers");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Demonstrate your commitment to the JavaScript community");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      Our levels of sponsorship are as follows. For higher levels,\n      logos/mentions/job postings will be larger and more prominent in all materials.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("Gold - $1200");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Company introduction during event opening");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Table at event (if desired)");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Posting on event job board (if desired)");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Logo/name on event website");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("Twitter mentions during and leading to event");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("5 passes");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("20% discount on additional tickets (limit of 5)");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("Silver - $800");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("3 passes to the event");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n      ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("10% discount on additional tickets (limit of 5)");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("Bronze - $500");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      A great fit for a smaller company, or seeking a simple way to raise your\n      profile among the area’s JavaScript developers.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("1 pass to the event");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("Additional sponsorship options:");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      These are great options if you’re seeking a unique way to showcase your\n      presence to attendees.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h4");
            var el2 = dom.createTextNode("Breakfast Sponsor: $600");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      The “early bird” advantage - sponsor breakfast, and you’ll be very\n      visible, first thing in the morning at a central popular event location!\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h4");
            var el2 = dom.createTextNode("Coffee Sponsor: $500");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      No technical event should be decaffeinated. With this sponsorship, you’ll\n      provide coffee/tea/drink options throughout the day to attendees. Includes\n      “Coffee sponsored by” signage in what we all know to be a high\n      foot-traffic area of events! This can be combined with a Bronze or Silver\n      sponsorship.\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n      None of these options quite what you’re looking for? Custom sponsorship\n      packages available\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n    ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("Contact Pam Selle at pam at thewebivore dot com");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n");
            dom.appendChild(el0, el1);
...
define('libertyjs-dev/templates/application', ['exports'], function (exports) {
        ...
        var child0 = (function() {
          return {
            ...
            build: function build(dom) {
              ...
              dom.appendChild(el2, el3);
              var el3 = dom.createElement("img");
              dom.setAttribute(el3,"src","/assets/images/logo-text.png");
              dom.setAttribute(el3,"alt","LibertyJS");
              dom.appendChild(el2, el3);
              var el3 = dom.createTextNode("\n        ");
              dom.appendChild(el2, el3);
              dom.appendChild(el1, el2);
        ...
        var child1 = (function() {
          ...
          var child6 = (function() {
            return {
              ...
              build: function build(dom) {
                var el0 = dom.createDocumentFragment();
                var el1 = dom.createTextNode("Code of Conduct");
                dom.appendChild(el0, el1);
                return el0;
              },
              render: function render(context, env, contextualElement) {
          ...
          return {
            ...
            build: function build(dom) {
              ...
              dom.setAttribute(el4,"href","http://www.meetup.com/Philadelphia-JavaScript-Developers/suggestion/");
      ...
      var child1 = (function() {
          ...
          var child0 = (function() {
            return {
              ...
              build: function build(dom) {
                ...
                dom.appendChild(el1, el2);
                var el2 = dom.createElement("a");
                dom.setAttribute(el2,"href","http://www.meetup.com/Philadelphia-JavaScript-Developers/");
                dom.setAttribute(el2,"target","_blank");
                var el3 = dom.createTextNode("\n              Meetup\n            ");
                dom.appendChild(el2, el3);
                dom.appendChild(el1, el2);
        ...
        return {
          ...
          render: function render(context, env, contextualElement) {
            ...
            block(env, morph1, context, "paper-card", [], {}, child0, null);
            return fragment;
          }
        };
      }());
...
define('libertyjs-dev/templates/components/base-focusable', ['exports'], function (exports) {
...
define('libertyjs-dev/templates/components/paper-button', ['exports'], function (exports) {
...
define('libertyjs-dev/templates/components/paper-checkbox', ['exports'], function (exports) {
...
define('libertyjs-dev/templates/components/paper-nav-container', ['exports'], function (exports) {
...
define('libertyjs-dev/templates/components/paper-radio', ['exports'], function (exports) {
...
define('libertyjs-dev/templates/components/paper-switch', ['exports'], function (exports) {
...
define('libertyjs-dev/templates/components/paper-text', ['exports'], function (exports) {
...
define('libertyjs-dev/tests/app.jshint', function () {
...
define('libertyjs-dev/tests/callforproposals/route.jshint', function () {

  'use strict';

  module('JSHint - callforproposals');
  test('callforproposals/route.js should pass jshint', function() { 
    ok(true, 'callforproposals/route.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tests/codeofconduct/route.jshint', function () {

  'use strict';

  module('JSHint - codeofconduct');
  test('codeofconduct/route.js should pass jshint', function() { 
    ok(true, 'codeofconduct/route.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tests/helpers/resolver', ['exports', 'ember/resolver', 'libertyjs-dev/config/environment'], function (exports, Resolver, config) {
...
define('libertyjs-dev/tests/helpers/resolver.jshint', function () {
...
define('libertyjs-dev/tests/helpers/start-app', ['exports', 'ember', 'libertyjs-dev/app', 'libertyjs-dev/router', 'libertyjs-dev/config/environment'], function (exports, Ember, Application, Router, config) {
...
define('libertyjs-dev/tests/helpers/start-app.jshint', function () {
...
define('libertyjs-dev/tests/router.jshint', function () {
...
define('libertyjs-dev/tests/schedule/route.jshint', function () {

  'use strict';

  module('JSHint - schedule');
  test('schedule/route.js should pass jshint', function() { 
    ok(true, 'schedule/route.js should pass jshint.'); 
  });
...
define('libertyjs-dev/tests/sponsors/route.jshint', function () {
  ...
  module('JSHint - sponsors');
  test('sponsors/route.js should pass jshint', function() { 
    ok(true, 'sponsors/route.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tests/sponsorship/route.jshint', function () {

  'use strict';

  module('JSHint - sponsorship');
  test('sponsorship/route.js should pass jshint', function() { 
    ok(true, 'sponsorship/route.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tests/test-helper', ['libertyjs-dev/tests/helpers/resolver', 'ember-qunit'], function (resolver, ember_qunit) {
...
define('libertyjs-dev/tests/test-helper.jshint', function () {
...
define('libertyjs-dev/tests/tickets/route.jshint', function () {

  'use strict';

  module('JSHint - tickets');
  test('tickets/route.js should pass jshint', function() { 
    ok(true, 'tickets/route.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tests/unit/callforpapers/route-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor('route:callforpapers', {});
...
define('libertyjs-dev/tests/unit/callforpapers/route-test.jshint', function () {

  'use strict';

  module('JSHint - unit/callforpapers');
  test('unit/callforpapers/route-test.js should pass jshint', function() { 
    ok(true, 'unit/callforpapers/route-test.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tests/unit/codeofconduct/route-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor('route:codeofconduct', {});
...
define('libertyjs-dev/tests/unit/codeofconduct/route-test.jshint', function () {

  'use strict';

  module('JSHint - unit/codeofconduct');
  test('unit/codeofconduct/route-test.js should pass jshint', function() { 
    ok(true, 'unit/codeofconduct/route-test.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tests/unit/routes/tickets-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor('route:tickets', {});
...
define('libertyjs-dev/tests/unit/routes/tickets-test.jshint', function () {

  'use strict';

  module('JSHint - unit/routes');
  test('unit/routes/tickets-test.js should pass jshint', function() { 
    ok(true, 'unit/routes/tickets-test.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tests/unit/schedule/route-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor('route:schedule', {});
...
define('libertyjs-dev/tests/unit/schedule/route-test.jshint', function () {

  'use strict';

  module('JSHint - unit/schedule');
  test('unit/schedule/route-test.js should pass jshint', function() { 
    ok(true, 'unit/schedule/route-test.js should pass jshint.'); 
  });
...
define('libertyjs-dev/tests/unit/sponsors/route-test.jshint', function () {

  'use strict';

  module('JSHint - unit/sponsors');
  test('unit/sponsors/route-test.js should pass jshint', function() { 
    ok(true, 'unit/sponsors/route-test.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tests/unit/sponsorship/route-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor('route:sponsorship', {});
...
define('libertyjs-dev/tests/unit/sponsorship/route-test.jshint', function () {

  'use strict';

  module('JSHint - unit/sponsorship');
  test('unit/sponsorship/route-test.js should pass jshint', function() { 
    ok(true, 'unit/sponsorship/route-test.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tests/unit/tickets/route-test', ['ember-qunit'], function (ember_qunit) {
...
define('libertyjs-dev/tests/unit/tickets/route-test.jshint', function () {

  'use strict';

  module('JSHint - unit/tickets');
  test('unit/tickets/route-test.js should pass jshint', function() { 
    ok(true, 'unit/tickets/route-test.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tests/unit/volunteer/route-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor('route:volunteer', {});
...
define('libertyjs-dev/tests/unit/volunteer/route-test.jshint', function () {

  'use strict';

  module('JSHint - unit/volunteer');
  test('unit/volunteer/route-test.js should pass jshint', function() { 
    ok(true, 'unit/volunteer/route-test.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tests/volunteer/route.jshint', function () {

  'use strict';

  module('JSHint - volunteer');
  test('volunteer/route.js should pass jshint', function() { 
    ok(true, 'volunteer/route.js should pass jshint.'); 
  });

});
define('libertyjs-dev/tickets/route', ['exports', 'ember'], function (exports, Ember) {
...
define('libertyjs-dev/tickets/template', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      ...
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("span");
          var el3 = dom.createTextNode("Tickets");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n  ");
          dom.appendChild(el1, el2);
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            var el1 = dom.createElement("iframe");
            dom.setAttribute(el1,"frameborder","0");
            dom.setAttribute(el1,"width","400");
            dom.setAttribute(el1,"height","400");
            dom.setAttribute(el1,"src","http://peatix.com/event/90362/share/widget?a=1&t=1");
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n");
...
define('libertyjs-dev/volunteer/route', ['exports', 'ember'], function (exports, Ember) {
...
define('libertyjs-dev/volunteer/template', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      ...
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("span");
          var el3 = dom.createTextNode("Volunteer");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n  ");
          dom.appendChild(el1, el2);
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("h3");
            var el2 = dom.createTextNode("Want to be part of the best JS conference in Philadelphia?!");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n  ");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n    We’re organizing volunteers for Liberty JS, an all-day javascript conference\n    at Impact Hub on June 20th, 2015.\n  ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n  ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("\n      Help the caterering companies set up for breakfast or lunch or deck party\n    ");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n    ");
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("li");
            var el3 = dom.createTextNode("\n      Random floor/navigation/event support\n    ");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n  ");
            dom.appendChild(el1, el2);
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n    We’re aiming for 2-3 hour shifts during the event if we get enough people.\n    So bring your friends!\n  ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n  ");
            dom.appendChild(el0, el1);
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("\n    Fill out the form below and we’ll send you an email with details on what\n    time to show up, and will invite you to the chatroom that day. The more the\n    merrier!\n  ");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n\n  ");
            dom.appendChild(el0, el1);
...
define('libertyjs-dev/config/environment', ['ember'], function(Ember) {
  var prefix = 'libertyjs-dev';
/* jshint ignore:start */
...
if (runningTests) {
  ...
  require("libertyjs-dev/app")["default"].create({"name":"libertyjs-dev","version":"0.0.0.0aa72f90"});
}

/* jshint ignore:end */
//# sourceMappingURL=libertyjs-dev.map